...
(Verbatim from [google-labs-code/design.md](https://github.com/google-labs-code/design.md); Apache License 2.0. Read when authoring or judging a visual identity.)
